...
from mainForm import Ui_Form as mainForm
from addEditCoffeeForm import Ui_Form as addEditCoffeeForm


class AddCoffeeForm(QMainWindow, addEditCoffeeForm):
...
class EditCoffeeForm(QMainWindow, addEditCoffeeForm):
    def __init__(self, parent=None):
        super().__init__(parent)
...
class MyWidget(QWidget, mainForm):
    def __init__(self):
        super().__init__()
        self.init_ui()
